      ...
      <div className="px-8 py-8 max-w-[1200px] mx-auto space-y-12">
        ...
        <section className="flex flex-col items-end gap-2">
          <div className="flex items-baseline gap-6">
            ...
            <span className="text-[13px] font-semibold text-black w-[140px] text-right">
          ...
          <div className="flex items-baseline gap-6 border-t border-black pt-2">
            ...
            <span className="text-[18px] font-semibold text-black w-[140px] text-right">
        ...
        <section>
          ...
          <AddressDisplay address={order.shippingAddress} bordered />
        </section>
